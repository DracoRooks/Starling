      ...
      <div className="relative w-full max-w-5xl md:h-175 h-140 rounded-lg">
        <AnimatedBorder>
          <div className="w-full h-full flex flex-col md:flex-row">
            {/* LEFT PANEL */}
            <div className="hidden md:w-1/2 md:max-h-full md:flex items-center justify-center p-6 
              bg-slate-800/70 md:border-r md:border-slate-500/50"
            >
              <div className="bg-[url('../../assets/login.png')] bg-cover min-w-full min-h-full"></div>
            </div>
            
            {/* RIGHT PANEL */}
            <div className="flex md:w-1/2 min-h-full max-h-full items-center justify-center p-10 rounded-l bg-slate-800/70">
